...
import type { Location, DailyForecast, HourlyForecast, SearchHistoryEntry } from './types';
        ...
        <section className="app-content">
          ...
          {location && daily[0] && (
            <>
              ...
              <OutlookSection today={daily[0]} unit={unit} />
              <DetailCards today={daily[0]} unit={unit} humidity={humidity} />
              <DailyForecastStrip
                forecasts={daily}
              ...
              {hourly.length > 0 && (
                <HourlyScroll
                  hourly={hourly}
                  unit={unit}
                  weatherCode={selectedDay?.weather_code}
                />
              )}
            </>
          )}
